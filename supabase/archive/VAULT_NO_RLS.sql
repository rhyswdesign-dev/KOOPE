-- VAULT MIGRATION WITHOUT RLS (for testing)
-- This creates the tables WITHOUT Row Level Security policies
-- Use this ONLY to test if the tables create successfully
...
-- Grant permissions (NO RLS policies)
...
-- You'll need to add RLS policies separately after this works

SELECT
  'Vault tables created WITHOUT RLS policies' as message,
