-- VAULT TRANSACTIONS SCHEMA MIGRATION (CLEAN)
-- First clean up any existing objects, then create fresh

-- ============================================
-- CLEANUP - Remove any existing objects
-- ============================================
...
-- ============================================
-- CREATE POLICIES (exact same pattern as working challenges migration)
-- ============================================
...
CREATE FUNCTION public.handle_new_user_vault_profile()
RETURNS TRIGGER AS $$
BEGIN
