 ...
 * Run: npx tsx scripts/delete-duplicates.ts
 */
...
// Recipe IDs to delete (the duplicates you don't want)
const recipesToDelete = [
  'dark-stormy',        // Dark 'N' Stormy (keeping dark-n-stormy)
  'martini-dry',        // Dry Martini (keeping dry-martini)
  'bee-sting',          // Bee's Knees (keeping bee-knees)
  'old-fashioned-classic' // Old Fashioned (keeping old-fashioned)
];

async function deleteDuplicates() {
  console.log('🗑️  Deleting duplicate recipes...\n');
  ...
  if (errorCount === 0) {
    ...
    console.log(`📚 You should now have ${139 - successCount} recipes remaining.`);
  }
}
