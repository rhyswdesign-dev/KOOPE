...
export type VaultCategoryId =
  'COCKTAIL_VARIATIONS' | 'TECHNIQUE_PLAYBOOKS' | 'SEASONAL_DROPS' | 'BARTENDER_HACKS' | 'GAMES'; // archived — kept for type safety on existing data
...
export const vaultCategories: VaultCategoryConfig[] = [
  {
    ...
    description:
      'Expand your repertoire with professional variations of classic cocktails. Each variation builds on familiar foundations with new techniques, ingredients, and flavor profiles.',
    sortOrder: 1,
  },
  {
    ...
    description:
      'Master the operational systems that separate home bartenders from professionals. These playbooks teach decision frameworks, not just techniques.',
    sortOrder: 2,
  },
  {
    id: 'SEASONAL_DROPS',
    ...
    description:
      'Exclusive seasonal content that rotates throughout the year. Get early access to curated collections of variations, playbooks, and bar features.',
    sortOrder: 4,
  },
  {
    id: 'BARTENDER_HACKS',
    ...
    description:
      'Short-form technique, flavour, and hosting insights — each one a single unlock. From dry shake fundamentals to acid balancing and ice strategy.',
    sortOrder: 3,
  },
...
export interface CocktailVariationContent {
  ...
  tags: string[];
  requiredLevel: number; // Phase 0.6: level-gated, not XP-spend
...
export const cocktailVariations: CocktailVariationContent[] = [
  // Simple variations (500-700 XP) - FREE tier to attract users
  {
    ...
    shortDescription:
      'Classic Old Fashioned enhanced with aromatic smoke. Learn wood chip selection and smoking techniques that complement bourbon and rye.',
    difficulty: 'simple',
    tags: ['smoked', 'bourbon', 'aromatic'],
    requiredLevel: 4, // was xpCost: 350
  ...
  },
  {
    ...
    shortDescription:
      'Margarita with balanced heat from jalapeño or habanero. Master the art of infusing spirits with controlled spice levels.',
    difficulty: 'simple',
    tags: ['spicy', 'tequila', 'citrus'],
    requiredLevel: 4, // was xpCost: 300
  ...
  },
  {
    ...
    baseClassicId: 'old_fashioned',
    shortDescription:
      'Fat-washed Old Fashioned with nutty brown butter richness. Learn fat-washing fundamentals and flavor extraction.',
    difficulty: 'simple',
    tags: ['fat-washed', 'rich', 'bourbon'],
    requiredLevel: 5, // was xpCost: 400
  ...
  // Technique-forward variations (900-1200 XP) - Mix of PLUS and PRO
  {
    ...
    shortDescription:
      'Crystal-clear Whiskey Sour using milk clarification. Master this showstopping technique that creates silky texture and extended shelf life.',
  ...
  },
  {
    ...
    shortDescription:
      'Nitrogen-infused Espresso Martini with cascading foam. Learn carbonation science and pressure dispensing for home bars.',
    difficulty: 'technique_forward',
    tags: ['nitro', 'coffee', 'foam', 'technique'],
    requiredLevel: 8, // was xpCost: 700
  ...
  },
  {
    ...
    shortDescription:
      'Daiquiri enhanced with citrus oil extraction. Master oleo saccharum preparation for depth and aromatics in any citrus cocktail.',
    difficulty: 'technique_forward',
  ...
  // Pro-level variations (1800-2200 XP) - All PRO tier
  {
    ...
    shortDescription:
      'Advanced Negroni using multiple base spirits for complexity. Learn spirit splitting theory and how to balance multiple flavor profiles.',
    difficulty: 'pro',
  ...
  },
  {
    ...
    shortDescription:
      'Manhattan aged in oak barrels for oxidative complexity. Master barrel aging at home, including wood selection and time management.',
    difficulty: 'pro',
    tags: ['aged', 'oak', 'complex', 'whiskey'],
    requiredLevel: 11, // was xpCost: 1000
  ...
  },
  {
    ...
    baseClassicId: 'margarita',
    shortDescription:
      'Margarita with lacto-fermented pineapple for funky complexity. Learn controlled fermentation for cocktail ingredients.',
    difficulty: 'pro',
    tags: ['fermented', 'funky', 'tequila', 'advanced'],
    requiredLevel: 10, // was xpCost: 950
  ...
  // Seasonal variations - PLUS tier for standard seasonal content
  {
    ...
    baseClassicId: 'negroni',
    shortDescription:
      'Negroni infused with warming winter spices like star anise, cinnamon, and cardamom. Perfect for cold weather entertaining.',
    difficulty: 'technique_forward',
    tags: ['spiced', 'winter', 'seasonal', 'bitter'],
    requiredLevel: 6, // was xpCost: 500
  ...
  },
  {
    ...
    baseClassicId: 'daiquiri',
    shortDescription:
      'Daiquiri showcasing peak-season berries with proper acid balance. Learn seasonal ingredient integration and preservation.',
    difficulty: 'simple',
...
export const techniquePlaybooks: TechniquePlaybookContent[] = [
  // Ice Strategy Playbooks
  {
    ...
    shortDescription:
      'Master ice decision logic for every cocktail type. Learn when size, shape, and clarity actually matter.',
    keyOutcomes: [
  ...
  },
  {
    ...
    playbookType: 'ICE_STRATEGY',
    shortDescription:
      'Plan ice quantities, storage, and preparation for events of any size. Never run out or waste freezer space.',
    keyOutcomes: [
  ...
  // Acid Control Playbooks
  {
    ...
    shortDescription:
      'Control acid types and ratios to fix flat drinks and achieve perfect balance in any cocktail.',
    keyOutcomes: [
  ...
  },
  {
    ...
    playbookType: 'ACID_CONTROL',
    shortDescription:
      'Rebalance batched cocktails and fix recipes that taste off. Master acid correction for any situation.',
    keyOutcomes: [
  ...
  // Batch Math Playbooks
  {
    ...
    shortDescription:
      'Scale cocktails from 1 to 50+ servings with proper dilution and balance. Essential for parties and prep.',
    keyOutcomes: [
    ...
    requiredLevel: 6, // was xpCost: 550
  ...
  },
  {
    ...
    playbookType: 'BATCH_MATH',
    shortDescription:
      'Master complex batching challenges: separation prevention, shelf life extension, and multi-cocktail prep.',
    keyOutcomes: [
  ...
  // Speed Systems Playbooks
  {
    ...
    shortDescription:
      'Design your bar setup for maximum efficiency. Professional station layout adapted for home bartending.',
    keyOutcomes: [
    ...
    requiredLevel: 5, // was xpCost: 450
  ...
  },
  {
    ...
    playbookType: 'SPEED_SYSTEM',
    shortDescription:
      'Learn professional build order logic by drink family. Make multiple drinks faster without sacrificing quality.',
    keyOutcomes: [
...
const _barFeatures: BarFeatureContent[] = [
  {
    ...
    city: 'Calgary',
    vibeDescription: 'Sophisticated luxury champagne lounge in Downtown Calgary.',
    signatureCocktailName: 'Golden Bubbles',
    whyItWorks: 'Dom Pérignon elevated with elderflower and gold leaf.',
    homeSubstitutions: 'Use Veuve Clicquot or Moët with St-Germain.',
  ...
  },
  {
    ...
    barName: 'Death & Co',
    city: 'New York City',
    vibeDescription: 'Intimate cocktail den in the East Village.',
    signatureCocktailName: 'Oaxaca Old Fashioned',
    whyItWorks: 'Split-base tequila/mezcal Old Fashioned.',
    homeSubstitutions: 'Sub Islay Scotch at 25% if no mezcal.',
  ...
  },
  {
    ...
    city: 'New York City',
    vibeDescription: 'Classic speakeasy-style bar in the West Village.',
    signatureCocktailName: 'Ginger Smash',
    whyItWorks: 'Fresh ginger and stone fruit with controlled dilution.',
    homeSubstitutions: 'Microplane-grate ginger; apricot liqueur in winter.',
  ...
  },
  {
    ...
    barName: 'Attaboy',
    city: 'New York City',
    vibeDescription: 'No-menu cocktail bar in the Lower East Side.',
    signatureCocktailName: "The Bartender's Choice",
    whyItWorks: 'A consultation framework, not a fixed recipe.',
    homeSubstitutions: 'Interview your guest, pick a template, make one custom modification.',
  ...
  },
  {
    ...
    barName: 'Trick Dog',
    city: 'San Francisco',
    vibeDescription: 'Playful neighborhood bar in the Mission District.',
    signatureCocktailName: 'Sherry Cobbler (Pantone 294)',
    whyItWorks: 'Modernized Cobbler showcasing fortified wine.',
    homeSubstitutions: 'Use Amontillado sherry; match fruit to season.',
...
export const seasonalDrops: SeasonalDropContent[] = [
  {
    ...
    description:
      "Master cold-weather cocktails with warming spices, barrel-aged spirits, and professional batching for holiday parties. Includes exclusive bar feature from NYC's top winter cocktail program.",
    includedVariationIds: [
      'var_winter_spiced_negroni',
      'var_brown_butter_old_fashioned',
      'var_aged_manhattan',
    ],
    includedPlaybookIds: ['playbook_batch_math_basics', 'playbook_ice_party_planning'],
  ...
  },
  {
    ...
    description:
      'Light, refreshing cocktails for warm weather. Learn seasonal fruit integration, batch prep for outdoor entertaining, and speed service systems for parties.',
    includedVariationIds: [
    ...
    includedPlaybookIds: ['playbook_acid_control_basics', 'playbook_speed_mise_en_place'],
  ...
  },
  {
    ...
    description:
      'Fresh, floral, and citrus-forward cocktails celebrating spring ingredients. Master technique-forward variations and acid control for bright, balanced drinks.',
    includedVariationIds: [
      'var_oleo_saccharum_daiquiri',
      'var_clarified_whiskey_sour',
      'var_fermented_pineapple_margarita',
    ],
    includedPlaybookIds: ['playbook_acid_control_basics', 'playbook_acid_rebalancing'],
...
export const drinkingGames: DrinkingGameContent[] = [
  // Classic Games
  {
    ...
    title: "King's Cup",
    shortDescription:
      'The ultimate card-based drinking game. Draw cards and perform actions based on the card drawn. A must-know for any party host.',
    players: '4–10+',
    difficulty: 'Easy',
    origin: 'USA',
    category: 'classic',
    requiredLevel: 3, // was xpCost: 200
  ...
  },
  {
    ...
    title: 'Flip Cup',
    shortDescription:
      'Fast-paced team relay game. Drink and flip your cup before the next player goes. Speed, coordination, and team spirit required.',
  ...
  },
  {
    ...
    title: 'Beer Pong',
    shortDescription:
      'The iconic party game. Toss ping pong balls into cups across the table. Master your arc and dominate the competition.',
    players: '2–4',
    difficulty: 'Medium',
    origin: 'USA',
    category: 'classic',
    requiredLevel: 3, // was xpCost: 250
    // FREE - popular game
  },
  ...
  // Cultural Games
  {
    ...
    title: 'Ring of Fire',
    shortDescription:
      "The British cousin of King's Cup with unique rule variations. Cards placed around a central cup create escalating stakes.",
    players: '2+',
    difficulty: 'Medium',
    origin: 'UK',
    category: 'cultural',
  ...
  },
  {
    ...
    title: 'Fuzzy Duck',
    shortDescription:
      "A tongue-twister drinking game that gets hilariously difficult. Say 'fuzzy duck' or 'ducky fuzz' without slipping up.",
    players: '2+',
    difficulty: 'Hard',
    origin: 'UK',
    category: 'cultural',
  ...
  // App-Enhanced Games
  {
    ...
    title: 'Truth or Dare',
    shortDescription:
      'The classic party game with a drinking twist. Refuse a truth or dare and take a drink. Includes curated question/dare decks.',
    players: '2–10',
    difficulty: 'Medium',
    origin: 'Global',
  ...
  },
  {
    ...
    shortDescription:
      'Vote on who in the group is most likely to do something outrageous. The person with the most votes drinks.',
    players: '2–10',
    difficulty: 'Easy',
    origin: 'Global',
    category: 'app_enhanced',
  ...
  // Party Games
  {
    ...
    title: 'Rage Cage',
    shortDescription:
      'High-intensity bouncing game with stacking cups. When someone catches up, stack your cup on theirs. Pure chaos.',
    players: '2+',
    difficulty: 'Hard',
    origin: 'Global',
    category: 'party',
  ...
  },
  {
    ...
    title: 'Power Hour',
    shortDescription:
      'Take a shot of beer every minute for 60 minutes. Simple concept, legendary endurance challenge. Includes a built-in timer.',
    players: '2+',
    difficulty: 'Easy',
    origin: 'Global',
    category: 'party',
 ...
 */
export function getVaultCategoryById(id: VaultCategoryId): VaultCategoryConfig | undefined {
  return vaultCategories.find((cat) => cat.id === id);
}

/**
 * Get all cocktail variations for display, soonest-to-unlock first.
 */
export function getVariationsForDisplay(userTier?: UserTier): CocktailVariationContent[] {
  ...
  return variations.sort((a, b) => a.requiredLevel - b.requiredLevel);
}
 ...
 */
export function getSeasonalDropById(dropId: string): SeasonalDropContent | undefined {
...
export function getItemsForSeasonalDrop(dropId: string): {
  ...
  const variations = cocktailVariations.filter((v) => drop.includedVariationIds.includes(v.id));

  const playbooks = techniquePlaybooks.filter((pb) => drop.includedPlaybookIds.includes(pb.id));
 ...
 * Get variation by ID
 */
export function getVariationById(id: string): CocktailVariationContent | undefined {
 ...
 * Get playbook by ID
 */
export function getPlaybookById(id: string): TechniquePlaybookContent | undefined {
...
export function getDrinkingGamesForDisplay(userTier?: UserTier): DrinkingGameContent[] {
  ...
  return games.sort((a, b) => a.requiredLevel - b.requiredLevel);
}
 ...
 */
export function getDrinkingGamesByCategory(
  category: DrinkingGameContent['category'],
): DrinkingGameContent[] {
 ...
 */
export function getVariationsByBaseClassic(baseClassicId: string): CocktailVariationContent[] {
...
export function searchVariationsByTag(tag: string): CocktailVariationContent[] {
  ...
  return cocktailVariations.filter((v) => v.tags.some((t) => t.toLowerCase().includes(lowerTag)));
}
...
export const bartenderHacks: BartenderHackContent[] = [
  ...
  },
  {
    ...
    requiredLevel: 2, // was xpCost: 150
  },
  {
...
export function getBartenderHacksForDisplay(userTier?: UserTier): BartenderHackContent[] {
  ...
  return hacks.sort((a, b) => a.requiredLevel - b.requiredLevel);
}
