...
export const WEEKLY_FOR_YOU_DROPS: WeeklyForYouDrop[] = [
  ...
  // ── Week 21 · May 17–23 ───────────────────────────────────────────────────
  {
    id: 'fyd-2026-w21-cocktail',
    slot: 'cocktail',
    tier: 'PLUS',
    recipeId: 'gimlet',
    title: 'Acid, Sugar, Spirit',
    eyebrow: 'Weekly Cocktail Drop',
    reason: 'The Gimlet strips out everything but ratio. Nail it and you understand every sour structure that follows.',
    profileTags: ['citrus', 'gin', 'sour', 'classic', 'beginner-friendly'],
    difficulty: 'easy',
    baseSpirit: 'gin',
    source: 'catalog',
    availableFrom: '2026-05-17T00:00:00.000Z',
    availableUntil: '2026-05-23T23:59:59.000Z',
  },
  {
    id: 'fyd-2026-w21-mocktail',
    slot: 'mocktail',
    tier: 'PRO',
    recipeId: 'dark-and-stormy',
    title: 'Storm in a Glass',
    eyebrow: 'Weekly Drop',
    reason: 'Spice, ginger, depth — the Dark & Stormy teaches why contrast makes a drink memorable.',
    profileTags: ['spicy', 'rum', 'refreshing', 'casual', 'beginner-friendly'],
    difficulty: 'easy',
    baseSpirit: 'rum',
    source: 'catalog',
    availableFrom: '2026-05-17T00:00:00.000Z',
  ...
  // ── Week 22 · May 24–30 ───────────────────────────────────────────────────
  {
    id: 'fyd-2026-w22-cocktail',
    slot: 'cocktail',
    tier: 'PLUS',
    recipeId: 'french-75',
    title: 'The Champagne Upgrade',
    eyebrow: 'Weekly Cocktail Drop',
    reason: 'Gin, lemon, sugar, bubbles — the French 75 is the easiest way to make any occasion feel like a moment.',
    profileTags: ['citrus', 'gin', 'sparkling', 'hosting', 'classic'],
    difficulty: 'easy',
    baseSpirit: 'gin',
    source: 'catalog',
    availableFrom: '2026-05-24T00:00:00.000Z',
    availableUntil: '2026-05-30T23:59:59.000Z',
  },
  {
    id: 'fyd-2026-w22-mocktail',
    slot: 'mocktail',
    tier: 'PRO',
    recipeId: 'espresso-martini',
    title: 'The Late Night Standard',
    eyebrow: 'Weekly Drop',
    reason: 'Espresso Martini is the drink that divided rooms and then won them all over. Learn it while everyone still orders it.',
    profileTags: ['coffee', 'vodka', 'sweet', 'hosting', 'after-dinner'],
    difficulty: 'medium',
    baseSpirit: 'vodka',
    source: 'catalog',
    availableFrom: '2026-05-24T00:00:00.000Z',
  ...
  {
    id: 'fyd-2026-w23-cocktail',
    slot: 'cocktail',
    tier: 'PLUS',
    recipeId: 'tommy-margarita',
    title: 'The Better Margarita',
    eyebrow: 'Weekly Cocktail Drop',
    reason: 'Agave syrup instead of triple sec — Tommy\'s strips the Margarita back to what tequila actually tastes like.',
    profileTags: ['citrus', 'tequila', 'agave', 'modern', 'adventurous'],
    difficulty: 'easy',
    baseSpirit: 'tequila',
    source: 'catalog',
    availableFrom: '2026-05-31T00:00:00.000Z',
    availableUntil: '2026-06-06T23:59:59.000Z',
  },
  {
    id: 'fyd-2026-w23-mocktail',
    slot: 'mocktail',
    tier: 'PRO',
    recipeId: 'clover-club',
    title: 'The Pink that Means Business',
    eyebrow: 'Weekly Drop',
    reason: 'Raspberry, lemon, egg white — the Clover Club looks delicate and drinks complex. A party crowd-pleaser that hides its technique.',
    profileTags: ['citrus', 'fruity', 'sour', 'hosting', 'classic'],
    difficulty: 'medium',
    baseSpirit: 'gin',
    source: 'catalog',
    availableFrom: '2026-05-31T00:00:00.000Z',
  ...
  // ── Week 24 · June 7–13 ───────────────────────────────────────────────────
  {
    id: 'fyd-2026-w24-cocktail',
    slot: 'cocktail',
    tier: 'PLUS',
    recipeId: 'paper-plane',
    title: 'Equal Parts Mastery',
    eyebrow: 'Weekly Cocktail Drop',
    reason: 'Four ingredients, equal parts, total balance. The Paper Plane is the modern bartender\'s pocket test for palate.',
    profileTags: ['bitter', 'citrus', 'whiskey', 'modern', 'adventurous'],
    difficulty: 'medium',
    baseSpirit: 'whiskey',
    source: 'catalog',
    availableFrom: '2026-06-07T00:00:00.000Z',
    availableUntil: '2026-06-13T23:59:59.000Z',
  },
  {
    id: 'fyd-2026-w24-mocktail',
    slot: 'mocktail',
    tier: 'PRO',
    recipeId: 'bee-sting',
    title: 'The Summer Sting',
    eyebrow: 'Weekly Drop',
    reason: 'Tequila, honey, lemon, jalapeño — sweet heat done right. The drink that teaches you hot and cold can coexist.',
    profileTags: ['spicy', 'citrus', 'tequila', 'sweet', 'adventurous'],
    difficulty: 'medium',
    baseSpirit: 'tequila',
    source: 'catalog',
    availableFrom: '2026-06-07T00:00:00.000Z',
  ...
  // ── Week 25 · June 14–20 ──────────────────────────────────────────────────
  {
    id: 'fyd-2026-w25-cocktail',
    slot: 'cocktail',
    tier: 'PLUS',
    recipeId: 'vieux-carre',
    title: 'New Orleans in a Glass',
    eyebrow: 'Weekly Cocktail Drop',
    reason: 'Rye, cognac, vermouth, bitters — the Vieux Carré is what happens when New Orleans decides to show off.',
    profileTags: ['spirit-forward', 'whiskey', 'classic', 'stirred', 'adventurous'],
    difficulty: 'medium',
    baseSpirit: 'whiskey',
    source: 'catalog',
    availableFrom: '2026-06-14T00:00:00.000Z',
    availableUntil: '2026-06-20T23:59:59.000Z',
  },
  {
    id: 'fyd-2026-w25-mocktail',
    slot: 'mocktail',
    tier: 'PRO',
    recipeId: 'singapore-sling',
    title: 'The Colonial Relic That Survived',
    eyebrow: 'Weekly Drop',
    reason: 'Overbuilt, over-garnished, and still on every great bar menu. The Singapore Sling teaches you why some drinks earn their complexity.',
    profileTags: ['fruity', 'citrus', 'gin', 'exotic', 'hosting'],
    difficulty: 'hard',
    baseSpirit: 'gin',
    source: 'catalog',
    availableFrom: '2026-06-14T00:00:00.000Z',
  ...
  // ── Week 26 · June 21–27 ──────────────────────────────────────────────────
  {
    id: 'fyd-2026-w26-cocktail',
    slot: 'cocktail',
    tier: 'PLUS',
    recipeId: 'naked-and-famous',
    title: 'The Symmetry Play',
    eyebrow: 'Weekly Cocktail Drop',
    reason: 'Equal parts mezcal, Aperol, yellow Chartreuse, and lemon. The Naked and Famous is the Paper Plane\'s smoky sibling.',
    profileTags: ['smoky', 'bitter', 'citrus', 'mezcal', 'adventurous'],
    difficulty: 'medium',
    baseSpirit: 'mezcal',
    source: 'catalog',
    availableFrom: '2026-06-21T00:00:00.000Z',
    availableUntil: '2026-06-27T23:59:59.000Z',
  },
  {
    id: 'fyd-2026-w26-mocktail',
    slot: 'mocktail',
    tier: 'PRO',
    recipeId: 'stone-fence',
    title: 'The Colonial Cooler',
    eyebrow: 'Weekly Drop',
    reason: 'Whiskey and apple cider — the oldest American bar drink and still one of the best for a summer evening.',
    profileTags: ['fruity', 'whiskey', 'refreshing', 'casual', 'classic'],
    difficulty: 'easy',
    baseSpirit: 'whiskey',
    source: 'catalog',
    availableFrom: '2026-06-21T00:00:00.000Z',
  ...
  {
    id: 'fyd-2026-w27-cocktail',
    slot: 'cocktail',
    tier: 'PLUS',
    recipeId: 'mint-julep',
    title: 'The American Summer',
    eyebrow: 'Weekly Cocktail Drop',
    reason: 'Bourbon, mint, crushed ice — the Mint Julep is a lesson in simplicity, dilution, and why technique changes everything.',
    profileTags: ['whiskey', 'refreshing', 'classic', 'summer', 'casual'],
    difficulty: 'easy',
    baseSpirit: 'whiskey',
    source: 'catalog',
    availableFrom: '2026-06-28T00:00:00.000Z',
    availableUntil: '2026-07-04T23:59:59.000Z',
  },
  {
    id: 'fyd-2026-w27-mocktail',
    slot: 'mocktail',
    tier: 'PRO',
    recipeId: 'tequila-sunrise',
    title: 'The Gradient Crowd-Pleaser',
    eyebrow: 'Weekly Drop',
    reason: 'Simple to make and impossible to ignore on a table. The Sunrise is what converts people to tequila.',
    profileTags: ['fruity', 'tequila', 'sweet', 'hosting', 'beginner-friendly'],
    difficulty: 'easy',
    baseSpirit: 'tequila',
    source: 'catalog',
    availableFrom: '2026-06-28T00:00:00.000Z',
  ...
  // ── Week 28 · July 5–11 ───────────────────────────────────────────────────
  {
    id: 'fyd-2026-w28-cocktail',
    slot: 'cocktail',
    tier: 'PLUS',
    recipeId: 'rum-old-fashioned',
    title: 'When Rum Gets Serious',
    eyebrow: 'Weekly Cocktail Drop',
    reason: 'The Old Fashioned template with aged rum reveals how much spirit character alone can carry a drink.',
    profileTags: ['rum', 'spirit-forward', 'stirred', 'adventurous', 'classic'],
    difficulty: 'easy',
    baseSpirit: 'rum',
    source: 'catalog',
    availableFrom: '2026-07-05T00:00:00.000Z',
    availableUntil: '2026-07-11T23:59:59.000Z',
  },
  {
    id: 'fyd-2026-w28-mocktail',
    slot: 'mocktail',
    tier: 'PRO',
    recipeId: 'pornstar-martini',
    title: 'The Modern Crowd Favorite',
    eyebrow: 'Weekly Drop',
    reason: 'Vanilla vodka, passionfruit, prosecco on the side — this is the drink that tells you exactly what a room wants.',
    profileTags: ['fruity', 'sweet', 'vodka', 'hosting', 'modern'],
    difficulty: 'easy',
    baseSpirit: 'vodka',
    source: 'catalog',
    availableFrom: '2026-07-05T00:00:00.000Z',
