...
export const PAYWALL_TRIGGERS: Record<string, PaywallTrigger> = {
  ...
  T2: {
    ...
    requiredPlan: 'plus',
    mode: 'hard',
    message: 'Advanced filters are part of the Bartender tier. Filter by ingredient count, sugar, ABV, and occasion with KŌOPE+.',
  ...
  T7: {
    ...
    requiredPlan: 'pro',
    mode: 'hard',
    message: 'Big-group hosting is a Mixologist feature. Go Pro for 5+ guest planning, batch optimization, and prep flow.',
