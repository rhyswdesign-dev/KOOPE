...
export const vaultItems: VaultItem[] = [
  // DRINKING GAMES (50 XP + 0 Keys) - Social party games for low XP cost
  {
    id: 'vault_game_kings_cup',
    name: 'King\'s Cup Rules',
    description: 'The classic drinking game with official rules and variations',
    image: 'https://images.unsplash.com/photo-1581805483934-504ff60dd080?auto=format&fit=crop&w=800&q=60',
    category: 'games',
    type: 'digital',
    rarity: 'common',
    xpCost: 200,
    ...
    contents: ['Official Rules', 'Card Assignments', 'Game Variations', 'House Rules Ideas'],
    estimatedValue: 'Fun Unlocked',
    isActive: true,
  ...
  {
    id: 'vault_game_never_have_i_ever',
    name: 'Never Have I Ever',
    description: 'Ice breaker game with 200+ question prompts',
    image: 'https://images.unsplash.com/photo-1541746972996-4e0b0f43e02a?auto=format&fit=crop&w=800&q=60',
    category: 'games',
    type: 'digital',
    rarity: 'common',
    xpCost: 200,
    ...
    currentStock: 999,
    cycleId: 'cycle_2025_01',
    contents: ['200+ Question Prompts', 'Category Filters', 'Difficulty Levels', 'Group Size Recommendations'],
    estimatedValue: 'Fun Unlocked',
    isActive: true,
    releaseDate: '2025-01-01T00:00:00Z',
    createdAt: '2024-12-31T12:00:00Z',
  ...
  {
    id: 'vault_game_truth_or_drink',
    name: 'Truth or Drink',
    description: 'The ultimate party game - answer honestly or take a drink',
    image: 'https://images.unsplash.com/photo-1560439513-74b037a25d84?auto=format&fit=crop&w=800&q=60',
    category: 'games',
    type: 'digital',
    rarity: 'common',
    xpCost: 200,
    ...
    currentStock: 999,
    cycleId: 'cycle_2025_01',
    contents: ['150+ Truth Questions', 'Icebreaker Mode', 'Deep Questions Mode', 'Group Game Rules'],
    estimatedValue: 'Fun Unlocked',
    isActive: true,
    releaseDate: '2025-01-01T00:00:00Z',
    createdAt: '2024-12-31T12:00:00Z',
  ...
  {
    id: 'vault_game_beer_pong',
    name: 'Beer Pong Rules & Variations',
    description: 'Official tournament rules plus creative variations',
    image: 'https://images.unsplash.com/photo-1574671928146-5c89a22b2e85?auto=format&fit=crop&w=800&q=60',
    category: 'games',
    type: 'digital',
    rarity: 'common',
    xpCost: 200,
    ...
    currentStock: 999,
    cycleId: 'cycle_2025_01',
    contents: ['Official Rules', 'Tournament Format', '10+ Game Variations', 'House Rules Guide'],
    estimatedValue: 'Fun Unlocked',
    isActive: true,
    releaseDate: '2025-01-01T00:00:00Z',
    createdAt: '2024-12-31T12:00:00Z',
  ...
  {
    id: 'vault_game_flip_cup',
    name: 'Flip Cup Tournament Guide',
    description: 'Team relay drinking game with pro strategies',
    ...
    currentStock: 999,
    cycleId: 'cycle_2025_01',
    contents: ['Official Rules', 'Pro Strategies', 'Tournament Bracket Builder', 'Team Formation Tips'],
    estimatedValue: 'Fun Unlocked',
    isActive: true,
    releaseDate: '2025-01-01T00:00:00Z',
    createdAt: '2024-12-31T12:00:00Z',
  ...
  {
    id: 'vault_game_quarters',
    name: 'Quarters Championship',
    description: 'The classic coin-bouncing drinking game',
    image: 'https://images.unsplash.com/photo-1560439513-74b037a25d84?auto=format&fit=crop&w=800&q=60',
    category: 'games',
    type: 'digital',
    rarity: 'common',
    ...
    currentStock: 999,
    cycleId: 'cycle_2025_01',
    contents: ['Game Rules', 'Skill Techniques', 'Power-Up Variations', 'Championship Format'],
    estimatedValue: 'Fun Unlocked',
    isActive: true,
    releaseDate: '2025-01-01T00:00:00Z',
    createdAt: '2024-12-31T12:00:00Z',
...
export const monetizationItems: MonetizationItem[] = [
  // INDIVIDUAL BOOSTERS
  {
    ...
    inStock: true,
    priceId: 'price_booster_2x_xp',
    productId: 'prod_booster_2x_xp',
...

  {
    ...
    priceId: 'price_booster_mystery_luck',
    productId: 'prod_booster_mystery_luck',
    createdAt: '2025-03-01T00:00:00Z',
    updatedAt: '2025-03-01T00:00:00Z',
  },
  ...
  // PHYSICAL MERCH (Real money only, no keys)
  {
    ...
    isBundle: false,
    inStock: true,
    priceId: 'price_merch_tshirt',
    productId: 'prod_merch_tshirt',
    createdAt: '2025-03-01T00:00:00Z',
    updatedAt: '2025-03-01T00:00:00Z',
  },
];
  ...
  unlockedItems: [
    {
      ...
      itemName: 'Untitled Champagne Lounge',
