...
const styles = StyleSheet.create({
  ...
  instructionText: {
    ...
    color: colors.text,
    textAlign: 'center',
    backgroundColor: 'rgba(26,18,13,0.82)',
    borderWidth: 1,
  ...
  flipButton: {
    ...
    height: 50,
    borderRadius: 25,
    backgroundColor: 'rgba(26,18,13,0.75)',
    borderWidth: 1,
  ...
  captureInner: {
    ...
    height: 52,
    borderRadius: 26,
    backgroundColor: 'rgba(26,18,13,0.5)',
  },
  galleryButton: {
    width: 50,
    height: 50,
  ...
  analyzingOverlay: {
    ...
    right: 0,
    bottom: 0,
    backgroundColor: 'rgba(26,18,13,0.85)',
    justifyContent: 'center',
    alignItems: 'center',
    borderRadius: radii.lg,
    margin: spacing(3),
