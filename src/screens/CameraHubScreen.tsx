...
const BACKGROUNDS: number[] = [
  require('../../assets/images/backgrounds/camera/bg-01.jpg'),
  require('../../assets/images/backgrounds/camera/bg-02.jpg'),
  require('../../assets/images/backgrounds/camera/bg-03.jpg'),
  require('../../assets/images/backgrounds/camera/bg-04.png'),
  require('../../assets/images/backgrounds/camera/bg-05.jpg'),
  require('../../assets/images/backgrounds/camera/bg-06.jpg'),
  require('../../assets/images/backgrounds/camera/bg-07.jpg'),
  require('../../assets/images/backgrounds/camera/bg-08.jpg'),
  require('../../assets/images/backgrounds/camera/bg-09.jpg'),
  require('../../assets/images/backgrounds/camera/bg-10.png'),
  require('../../assets/images/backgrounds/camera/bg-11.jpg'),
  require('../../assets/images/backgrounds/camera/bg-12.png'),
  require('../../assets/images/backgrounds/camera/bg-14.jpg'),
  ...
  require('../../assets/images/backgrounds/camera/bg-21.jpg'),
