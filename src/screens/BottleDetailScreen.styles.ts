...
export const styles = StyleSheet.create({
  ...
  // Low-confidence nudge — the only piece of the scan-feedback flow that
  // stays above the fold; the panel itself lives in ScanFeedbackPanel.tsx.
  lowConfidenceNudge: {
    flexDirection: 'row',
    alignItems: 'center',
