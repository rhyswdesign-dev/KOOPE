      ...
      <FlatList
        ...
        ListHeaderComponent={
          <View>
            ...
            <ScrollView horizontal nestedScrollEnabled showsHorizontalScrollIndicator={false} style={{ paddingLeft: spacing(2), marginBottom: spacing(2) }}>
              {sampleRecipes?.filter(m => m.subtitle?.includes('Zero-Proof')).map((mocktail, index) => {
            ...
            <ScrollView horizontal nestedScrollEnabled showsHorizontalScrollIndicator={false} style={{ paddingLeft: spacing(2), marginBottom: spacing(2) }}>
              {sampleRecipes?.filter(m => m.subtitle?.includes('Wellness')).map((mocktail, index) => {
                const cardProps = createRecipeCardProps(mocktail, navigation, {
                  toggleSavedCocktail,
                  isCocktailSaved,
                  setSelectedRecipe,
            ...
            <ScrollView horizontal nestedScrollEnabled showsHorizontalScrollIndicator={false} style={{ paddingLeft: spacing(2), marginBottom: spacing(2) }}>
              {sampleRecipes?.filter(m => m.subtitle?.includes('Low-ABV')).map((mocktail, index) => {
                const cardProps = createRecipeCardProps(mocktail, navigation, {
                  toggleSavedCocktail,
                  isCocktailSaved,
                  setSelectedRecipe,
