...
const CANONICAL_INGREDIENTS: CanonicalIngredient[] = [
  // --- Spirits ---
  {
    ...
    displayName: 'Vodka',
    category: 'spirit',
    aliases: ['vodka', 'potato vodka', 'grain vodka'],
    substitutionGroup: 'vodka',
  },
  {
    id: 'gin-london-dry',
    displayName: 'London Dry Gin',
    category: 'spirit',
    subcategory: 'london dry',
    aliases: ['gin', 'london dry gin', 'dry gin'],
    substitutionGroup: 'gin',
  },
  {
    id: 'gin-plymouth',
    displayName: 'Plymouth Gin',
    category: 'spirit',
    subcategory: 'plymouth',
  ...
  },
  {
    ...
    category: 'spirit',
    subcategory: 'bourbon',
    aliases: ['bourbon', 'bourbon whiskey', 'kentucky bourbon'],
    substitutionGroup: 'whiskey',
  },
  {
    id: 'rye-whiskey',
  ...
  },
  {
    ...
    category: 'spirit',
    subcategory: 'scotch',
    aliases: ['scotch', 'scotch whisky', 'blended scotch'],
    substitutionGroup: 'whiskey',
  },
  {
    id: 'irish-whiskey',
    displayName: 'Irish Whiskey',
    category: 'spirit',
    subcategory: 'irish',
  ...
  },
  {
    ...
    category: 'spirit',
    subcategory: 'white',
    aliases: ['white rum', 'light rum', 'silver rum'],
    substitutionGroup: 'rum',
  },
  {
    id: 'dark-rum',
    ...
    category: 'spirit',
    subcategory: 'dark',
    aliases: ['dark rum', 'black rum'],
    substitutionGroup: 'rum',
  },
  {
    id: 'aged-rum',
    displayName: 'Aged Rum',
    category: 'spirit',
    subcategory: 'aged',
    aliases: ['aged rum', 'gold rum', 'añejo rum'],
    substitutionGroup: 'rum',
  },
  {
    id: 'spiced-rum',
  ...
  {
    id: 'tequila-blanco',
    displayName: 'Tequila Blanco',
    category: 'spirit',
    subcategory: 'blanco',
    aliases: ['tequila', 'tequila blanco', 'silver tequila', 'blanco tequila'],
    substitutionGroup: 'tequila',
  },
  {
    id: 'tequila-reposado',
    displayName: 'Tequila Reposado',
    category: 'spirit',
    subcategory: 'reposado',
    aliases: ['tequila reposado', 'reposado tequila'],
    substitutionGroup: 'tequila',
  },
  {
    id: 'mezcal',
  ...
  },
  {
    ...
    category: 'spirit',
    subcategory: 'cognac',
    aliases: ['cognac', 'vs cognac', 'vsop cognac'],
    substitutionGroup: 'brandy',
  },
  {
    id: 'brandy',
    displayName: 'Brandy',
  ...
  // --- Liqueurs & Modifiers ---
  {
    ...
    category: 'liqueur',
    aliases: ['triple sec'],
    substitutionGroup: 'orange-liqueur',
  },
  {
    id: 'cointreau',
  ...
  },
  {
    ...
    displayName: 'Curaçao',
    category: 'liqueur',
    aliases: ['curaçao', 'curacao', 'blue curacao', 'orange curacao'],
    substitutionGroup: 'orange-liqueur',
  },
  {
    id: 'campari',
    ...
    category: 'liqueur',
    aliases: ['campari'],
    substitutionGroup: 'bitter-liqueur',
  },
  {
    id: 'aperol',
    displayName: 'Aperol',
  ...
  },
  {
    ...
    category: 'wine',
    aliases: ['sweet vermouth', 'rosso vermouth', 'red vermouth'],
    substitutionGroup: 'sweet-vermouth',
  },
  {
    id: 'dry-vermouth',
    displayName: 'Dry Vermouth',
    category: 'wine',
    aliases: ['dry vermouth', 'french vermouth', 'extra dry vermouth'],
    substitutionGroup: 'dry-vermouth',
  },
  {
    id: 'amaretto',
    ...
    substitutionGroup: 'amaretto',
  },
  {
    id: 'kahlua',
    displayName: 'Kahlúa',
    category: 'liqueur',
    aliases: ['kahlúa', 'kahlua', 'coffee liqueur'],
    substitutionGroup: 'coffee-liqueur',
  },
  {
    id: 'maraschino',
    displayName: 'Maraschino Liqueur',
    category: 'liqueur',
    aliases: ['maraschino', 'maraschino liqueur', 'luxardo maraschino'],
    substitutionGroup: 'maraschino',
  },
  {
    id: 'chartreuse-green',
    displayName: 'Green Chartreuse',
    category: 'liqueur',
    aliases: ['green chartreuse', 'chartreuse'],
    substitutionGroup: 'chartreuse',
  },
  {
    id: 'st-germain',
    displayName: 'St-Germain',
    category: 'liqueur',
    aliases: ['st-germain', 'st germain', 'elderflower liqueur'],
    substitutionGroup: 'elderflower',
  },
  ...
  // --- Wine ---
  {
    ...
    category: 'wine',
    aliases: ['champagne', 'sparkling wine'],
    substitutionGroup: 'sparkling-wine',
  },
  {
    id: 'prosecco',
    displayName: 'Prosecco',
    category: 'wine',
    aliases: ['prosecco', 'cava'],
    substitutionGroup: 'sparkling-wine',
  },
  {
    id: 'sherry',
    displayName: 'Sherry',
    category: 'wine',
    aliases: ['sherry', 'fino sherry', 'oloroso sherry'],
    substitutionGroup: 'sherry',
  },
  {
    id: 'port',
    displayName: 'Port',
    category: 'wine',
    aliases: ['port', 'port wine', 'tawny port', 'ruby port'],
    substitutionGroup: 'port',
  },
  ...
  // --- Mixers ---
  {
    ...
    category: 'mixer',
    aliases: ['tonic water', 'tonic'],
    substitutionGroup: 'tonic',
  },
  {
    id: 'soda-water',
    displayName: 'Soda Water',
    category: 'mixer',
    aliases: ['soda water', 'club soda', 'sparkling water', 'seltzer'],
    substitutionGroup: 'soda',
  },
  {
    id: 'ginger-beer',
  ...
  },
  {
    ...
    displayName: 'Cola',
    category: 'mixer',
    aliases: ['cola', 'coca-cola', 'coke', 'pepsi'],
    substitutionGroup: 'cola',
  },
  {
    id: 'cranberry-juice',
    displayName: 'Cranberry Juice',
    category: 'mixer',
    aliases: ['cranberry juice', 'cran'],
    substitutionGroup: 'cranberry',
  },
  {
    id: 'pineapple-juice',
    ...
    substitutionGroup: 'pineapple-juice',
  },
  {
    id: 'coconut-cream',
    displayName: 'Coconut Cream',
    category: 'mixer',
    aliases: ['coconut cream', 'cream of coconut', 'coco lopez'],
    substitutionGroup: 'coconut',
  },
  ...
  // --- Bitters ---
  {
    ...
    category: 'bitters',
    aliases: ['angostura bitters', 'angostura', 'aromatic bitters'],
    substitutionGroup: 'aromatic-bitters',
  },
  {
    id: 'orange-bitters',
    ...
    substitutionGroup: 'orange-bitters',
  },
  {
    id: 'peychauds',
    displayName: "Peychaud's Bitters",
    category: 'bitters',
    aliases: ["peychaud's bitters", 'peychauds bitters', "peychaud's"],
    substitutionGroup: 'peychauds',
  },
  ...
  // --- Syrups ---
  {
    ...
    category: 'syrup',
    aliases: ['simple syrup', 'sugar syrup', '1:1 syrup'],
    substitutionGroup: 'simple-sweet',
  },
  {
    id: 'rich-simple',
    displayName: 'Rich Simple Syrup',
    category: 'syrup',
    aliases: ['rich simple syrup', '2:1 syrup', 'rich simple'],
    substitutionGroup: 'simple-sweet',
  },
  {
    id: 'honey-syrup',
  ...
  },
  {
    ...
    category: 'syrup',
    aliases: ['agave syrup', 'agave nectar', 'agave'],
    substitutionGroup: 'simple-sweet',
  },
  {
    id: 'demerara-syrup',
    displayName: 'Demerara Syrup',
    category: 'syrup',
    aliases: ['demerara syrup', 'demerara'],
    substitutionGroup: 'simple-sweet',
  },
  {
    id: 'maple-syrup',
  ...
  },
  {
    ...
    category: 'syrup',
    aliases: ['grenadine'],
    substitutionGroup: 'grenadine',
  },
  {
    id: 'orgeat',
    displayName: 'Orgeat',
    category: 'syrup',
    aliases: ['orgeat', 'orgeat syrup', 'almond syrup'],
    substitutionGroup: 'orgeat',
  },
  ...
  // --- Citrus / Juice ---
  {
    ...
    category: 'garnish',
    aliases: ['lime juice', 'fresh lime juice', 'freshly squeezed lime juice'],
    substitutionGroup: 'citrus-sour',
  },
  {
    id: 'lemon-juice',
    displayName: 'Lemon Juice',
    category: 'garnish',
    aliases: ['lemon juice', 'fresh lemon juice', 'freshly squeezed lemon juice'],
    substitutionGroup: 'citrus-sour',
  },
  {
    id: 'orange-juice',
    ...
    category: 'garnish',
    aliases: ['orange juice', 'fresh orange juice', 'oj'],
    substitutionGroup: 'citrus-sweet',
  },
  {
    id: 'grapefruit-juice',
  ...
  // --- Garnishes ---
  {
    ...
    displayName: 'Lime',
    category: 'garnish',
    aliases: ['lime', 'lime wedge', 'lime wheel', 'lime slice', 'lime peel', 'lime twist'],
    substitutionGroup: 'lime-garnish',
  },
  {
    id: 'lemon',
    displayName: 'Lemon',
    category: 'garnish',
    aliases: ['lemon', 'lemon wedge', 'lemon wheel', 'lemon slice', 'lemon peel', 'lemon twist'],
    substitutionGroup: 'lemon-garnish',
  },
  {
    id: 'orange',
    displayName: 'Orange',
    ...
    substitutionGroup: 'orange-garnish',
  },
  {
    id: 'cherry',
    displayName: 'Maraschino Cherry',
    category: 'garnish',
    aliases: ['cherry', 'maraschino cherry', 'cocktail cherry', 'luxardo cherry'],
    substitutionGroup: 'cherry',
  },
  {
    id: 'mint',
    displayName: 'Fresh Mint',
    category: 'garnish',
    aliases: ['mint', 'fresh mint', 'mint leaves', 'mint sprig'],
    substitutionGroup: 'mint',
  },
  {
    id: 'olive',
    displayName: 'Olive',
    category: 'garnish',
    aliases: ['olive', 'green olive', 'cocktail olive'],
    substitutionGroup: 'olive',
  },
  ...
  // --- Other Ingredients ---
  {
    ...
    substitutionGroup: 'egg-white',
  },
  {
    id: 'aquafaba',
    displayName: 'Aquafaba',
    category: 'ingredient',
    aliases: ['aquafaba', 'chickpea water'],
    substitutionGroup: 'egg-white',
  },
  {
    id: 'cream',
    ...
    category: 'ingredient',
    aliases: ['cream', 'heavy cream', 'double cream', 'whipping cream'],
  ...
  },
  {
    ...
    category: 'ingredient',
    aliases: ['half and half', 'half & half', 'half-and-half'],
    substitutionGroup: 'cream',
  },
  {
    id: 'sugar',
    displayName: 'Sugar',
    category: 'ingredient',
    aliases: ['sugar', 'white sugar', 'granulated sugar', 'sugar cube', 'sugar cubes'],
    substitutionGroup: 'sugar',
  },
];
...
export function inferCategory(ingredientName: string): BottleCategory {
  ...
  if (/vodka|gin|rum|whiskey|bourbon|tequila|mezcal|brandy|cognac|scotch|pisco/i.test(lower))
    return 'spirit';
  if (/champagne|prosecco|cava|sparkling wine|vermouth|sherry|port wine/i.test(lower))
    return 'wine';
  if (/liqueur|triple sec|cointreau|campari|aperol|amaretto|chartreuse/i.test(lower))
    return 'liqueur';
  ...
  if (/lemon|lime|orange|cherry|mint|olive|cucumber|garnish|wedge|twist|wheel|peel/i.test(lower))
    return 'garnish';
  return 'ingredient';
}
...
export function searchCanonical(query: string, limit: number = 10): CanonicalIngredient[] {
  ...
  const results: { ingredient: CanonicalIngredient; score: number }[] = [];
...
function cleanIngredientName(name: string): string {
  return name
    .toLowerCase()
    .replace(
      /\d+(\.\d+)?\s*(oz|ml|cl|dash|dashes|drops?|splash|barspoon|tsp|tbsp|cup|part|parts)\b/gi,
      '',
    )
    .replace(
      /\b(fresh|freshly\s+squeezed|chilled|cold|warm|hot|large|small|thin|thick|whole)\b/gi,
      '',
    )
    .replace(/\s+/g, ' ')
    .trim();
